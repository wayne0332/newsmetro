...
private static final String DES_ALGORITHM = "DES";
	 ...
	 * @throws Exception
	 */
	public String getEncryptString(String plainData, String secretKey) throws Exception{
	 ...
	 * @throws Exception
	 */
	public String getDecryptString(String secretData, String secretKey) throws Exception{
		...
		try {
			...
			byte[] buf = cipher.doFinal(base64De.decodeBuffer(secretData));
...
//	}
	...
	public static void main(String[] a) throws Exception{
		...
		String input2 = "Owc3Ng7WWYlljip6MYq+gZoDJEPAx1g9M3yUwF7sTul35ZzYF/MCf/GDpMeo9nLdK4MoXezon0o=";
		String key = "37d5aed075525d4fa0fe635231cba447";
		
		DESUtil des = new DESUtil();
		
		String result = des.getEncryptString(input, key);
		System.out.println(result);
		
		System.out.println(des.getDecryptString(input2, key));
